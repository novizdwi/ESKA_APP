...
namespace Models.Setting.Report
{
    ...
    public class Report__List_Model
    {
        static string ViewSql = @"SELECT T0.""Id"", T1.""GroupName"", T0.""ReportName"", T0.""IsActive""
                                FROM ""Tm_Report"" T0 
                                LEFT JOIN ""Tm_ReportGroup"" T1 ON T0.""GroupId""=T1.""Id""
                                ";
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Name = "List Report";
            settings.KeyFieldName = "Id";
            settings.Columns.Add("Id", "Id");
            settings.Columns.Add("ReportName", "Report Name"); 

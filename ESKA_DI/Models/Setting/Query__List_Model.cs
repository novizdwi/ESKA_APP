...
namespace Models.Setting.Query
{
    ...
    public class Query__List_Model
    {
        static string ViewSql = @"SELECT T0.""Id"", T1.""GroupName"", T0.""QueryName"", T0.""IsActive""
                                FROM ""Tm_Query"" T0 
                                LEFT JOIN ""Tm_QueryGroup"" T1 ON T0.""GroupId""=T1.""Id""
                                ";
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Name = "List Query";
            settings.KeyFieldName = "Id";
            settings.Columns.Add("Id", "Id");
            settings.Columns.Add("QueryName", "Query Name");

...
namespace Controllers.Transaction
{
    ...
    {
        public ListFindParamInventoryTransfer GetParam(HttpRequestBase Request)
        {

            var param = new ListFindParamInventoryTransfer();
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvInventoryTransferList");
            if (viewModel == null)
            {
                viewModel = InventoryTransfer__List_Model.CreateGridViewModel();
            }

            return viewModel;
        }

        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParamInventoryTransfer param)
        {

            InventoryTransfer__List_Model.SetBindingData(viewModel, userId, param);

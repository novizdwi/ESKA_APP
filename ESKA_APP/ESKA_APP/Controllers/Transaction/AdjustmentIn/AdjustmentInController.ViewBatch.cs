...
namespace Controllers.Transaction
{
    public partial class AdjustmentInController : BaseController
    {
        ...
        public ActionResult ViewBatch_PopupListOnDemandPartial(long id = 0, long detId = 0)
        {
            ...
            var model = new AdjustmentInBatchView___();
            if (id != 0 && detId != 0)
            {
                model = adjustmentInService.GetAdjustmentIn_Batch(id, detId);
            }
        ...
        public ActionResult TabBatchListPartial(long Id = 0, long DetId = 0)
        {
            ...
            var modelList = adjustmentInService.GetAdjustmentIn_ItemBatchList(Id, DetId); 
        ...
        public ActionResult TabBatchListAddNewRow([Bind] AdjustmentInBatchModel model, long Id = 0, long DetId = 0)
        {
            long id = Id;
            long detId = DetId;
            adjustmentInService = new AdjustmentInService();
            ...
            if (ModelState.IsValid)
            {
                ...
                adjustmentInService.AdjustmentIn_AddNewItemBatch(model);
            }
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult TabBatchListUpdateRow([Bind] AdjustmentInBatchModel model, long Id = 0, long DetId = 0) {
            long id = Id;
            long detId = DetId;
            adjustmentInService = new AdjustmentInService();
            ...
            { 
                ...
                model.Id = Id;
                model.DetId = DetId;
                adjustmentInService.AdjustmentIn_UpdateItemBatch(model);
            }
        ...
        public ActionResult TabBatchListDeleteRow(long DetDetId, long Id = 0, long DetId = 0)
        {
            ...
            if (ModelState.IsValid)
            {
                adjustmentInService.AdjustmentIn_DeleteItemBatch(userId, Id, DetId, DetDetId);
            }

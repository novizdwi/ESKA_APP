...
namespace Controllers.Transaction
{
    ...
    {
        public ListFindParamStockOpname GetParam(HttpRequestBase Request)
        {

            var param = new ListFindParamStockOpname();
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvStockOpnameList");
            if (viewModel == null)
            {
                viewModel = StockOpname__List_Model.CreateGridViewModel();
            }

            return viewModel;
        }

        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParamStockOpname param)
        {

            StockOpname__List_Model.SetBindingData(viewModel, userId, param);

...
namespace Controllers.Transaction.StockOpname
{
    ...
    {
        public ListFindParamRequestStockOpname GetParam(HttpRequestBase Request)
        {

            var param = new ListFindParamRequestStockOpname();
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvRequestStockOpnameList");
            if (viewModel == null)
            {
                viewModel = RequestStockOpname__List_Model.CreateGridViewModel();
            }

            return viewModel;
        }

        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParamRequestStockOpname param)
        {

            RequestStockOpname__List_Model.SetBindingData(viewModel, userId, param);

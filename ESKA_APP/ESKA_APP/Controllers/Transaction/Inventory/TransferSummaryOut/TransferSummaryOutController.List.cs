...
namespace Controllers.Transaction.Inventory
{
    ...
    {
        public ListFindParamTransferSummaryOut GetParam(HttpRequestBase Request)
        {

            var param = new ListFindParamTransferSummaryOut();
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvTransferSummaryOutList");
            if (viewModel == null)
            {
                viewModel = TransferSummaryOut__List_Model.CreateGridViewModel();
            }

            return viewModel;
        }

        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParamTransferSummaryOut param)
        {

            TransferSummaryOut__List_Model.SetBindingData(viewModel, userId, param);

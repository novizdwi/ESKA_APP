...
namespace Controllers._Cfl
{
    public partial class _CflRoutingController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflRouting_View__> items = null;
            return GridViewExportHelper.ExportTypes["XLS"].Method(GridViewExportHelper.ExportGridViewSettings(cflRoutingParam), items);
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflRouting_ParamModel cflRoutingParam)
            {
                if (exportGridViewSettings == null)
                    exportGridViewSettings = CreateExportGridViewSettings(cflRoutingParam);
                return exportGridViewSettings;
            }
            static GridViewSettings CreateExportGridViewSettings(CflRouting_ParamModel cflRoutingParam)
            {

                GridViewSettings settings = CflRouting_Model.CreateExportGridViewSettings(cflRoutingParam);

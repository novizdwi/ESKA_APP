...
namespace Controllers._Cfl
{
    public partial class _CflItemByWarehouseController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflItemByWarehouse_View__> items = CflItemByWarehouse_Model.GetDataList(userId, cflItemByWarehouseParam, filterExpression, sortExpression, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize));
            return GridViewExportHelper.ExportTypes["XLS"].Method(GridViewExportHelper.ExportGridViewSettings(cflItemByWarehouseParam), items);
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflItemByWarehouse_ParamModel cflItemByWarehouseParam)
            {
                //get
                //{
                if (exportGridViewSettings == null)
                    exportGridViewSettings = CreateExportGridViewSettings(cflItemByWarehouseParam);
                return exportGridViewSettings;
                //}
            }
            static GridViewSettings CreateExportGridViewSettings(CflItemByWarehouse_ParamModel cflItemByWarehouseParam)
            {

                GridViewSettings settings = CflItemByWarehouse_Model.CreateExportGridViewSettings(cflItemByWarehouseParam);

...
namespace Controllers._Cfl
{
    public partial class _CflCardCodeController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflCardCode_View__> items = null;//= CflCardCode_Model.GetDataList(userId, cflBpParam, filterExpression, sortExpression, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize));
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflCardCode_ParamModel cflBpParam)
            {
                //get
                //{
            ...
            static GridViewSettings CreateExportGridViewSettings(CflCardCode_ParamModel cflBpParam)
            {

                GridViewSettings settings = CflCardCode_Model.CreateExportGridViewSettings(cflBpParam);

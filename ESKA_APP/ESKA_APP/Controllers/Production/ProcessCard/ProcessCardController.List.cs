...
namespace Controllers.Production
{
    ...
    {
        public ListFindParamProcessCard GetParam(HttpRequestBase Request)
        {

            var param = new ListFindParamProcessCard();
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvProcessCardList");
            if (viewModel == null)
            {
                viewModel = ProcessCard__List_Model.CreateGridViewModel();
            }

            return viewModel;
        }

        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParamProcessCard param)
        {

            ProcessCard__List_Model.SetBindingData(viewModel, userId, param);

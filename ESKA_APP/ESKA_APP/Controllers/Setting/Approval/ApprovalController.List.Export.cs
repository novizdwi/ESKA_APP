...
namespace Controllers.Setting
{
    public partial class ApprovalController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<ApprovalView__> items = Approval__List_Model.GetDataList(hidden_CpGvFind_FilterExpression, hidden_CpGvFind_SortExpression, Convert.ToInt32(hidden_CpGvFind_PageIndex), Convert.ToInt32(hidden_CpGvFind_PageSize));
        ...
        public partial class GridViewExportHelper
        {
            ...
            static GridViewSettings CreateExportGridViewSettings()
            {
                ...
                GridViewSettings settings = Approval__List_Model.CreateExportGridViewSettings();

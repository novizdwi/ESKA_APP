...
namespace Controllers.Setting
{
    ...
    { 
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvApprovalList");
            if (viewModel == null)
            {
                viewModel = Approval__List_Model.CreateGridViewModel();
            }
        ...
        {
            Approval__List_Model.SetBindingData(viewModel);

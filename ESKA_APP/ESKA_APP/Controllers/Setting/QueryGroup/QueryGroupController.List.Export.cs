...
namespace Controllers.Setting
{
    public partial class QueryGroupController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<View___> views = QueryGroup__List_Model.GetDataList(hidden_CpGvFind_FilterExpression, hidden_CpGvFind_SortExpression, Convert.ToInt32(hidden_CpGvFind_PageIndex), Convert.ToInt32(hidden_CpGvFind_PageSize));
        ...
        public partial class GridViewExportHelper
        {
            ...
            static GridViewSettings CreateExportGridViewSettings()
            {
                ...
                GridViewSettings settings = QueryGroup__List_Model.CreateExportGridViewSettings();

...
namespace Controllers.Setting
{
    ...
    { 
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvQueryGroupList");
            if (viewModel == null)
            {
                viewModel = QueryGroup__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(GridViewModel viewModel)
        {
            viewModel.ProcessCustomBinding(
                QueryGroup__List_Model.GetDataRowCount,
                QueryGroup__List_Model.GetData
            );

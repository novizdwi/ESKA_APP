...
namespace Controllers.Setting
{
    ...
    { 
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvLayoutList");
            if (viewModel == null)
            {
                viewModel = Layout__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(GridViewModel viewModel)
        {
            viewModel.ProcessCustomBinding(
                Layout__List_Model.GetDataRowCount,
                Layout__List_Model.GetData
            );

...
namespace Controllers.Setting
{
    public partial class ApprovalStageController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<ApprovalStageView__> items = ApprovalStage__List_Model.GetDataList(hidden_CpGvFind_FilterExpression, hidden_CpGvFind_SortExpression, Convert.ToInt32(hidden_CpGvFind_PageIndex), Convert.ToInt32(hidden_CpGvFind_PageSize));

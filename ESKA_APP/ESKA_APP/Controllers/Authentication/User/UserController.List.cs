...
namespace Controllers.Authentication
{
    ...
    { 
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvUserList");
            if (viewModel == null)
            {
                viewModel = User__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(GridViewModel viewModel)
        {
            viewModel.ProcessCustomBinding(
                User__List_Model.GetDataRowCount,
                User__List_Model.GetData
            );
